...
void set_mpu(void)
{
	...
	REG(MPU_BASE+MPU_RBAR_OFFSET)=MPU_RASR_VALUE( MPU_XN_DISABLE , MPU_AP_FULL_ACCESS , MPU_TYPE_FLASH , 0 , MPU_REGION_SIZE_1MB );
	...
	REG(MPU_BASE+MPU_RBAR_OFFSET)=MPU_RASR_VALUE( MPU_XN_DISABLE , MPU_AP_FULL_ACCESS , MPU_TYPE_FLASH , 0 , MPU_REGION_SIZE_128KB );
	...
	REG(MPU_BASE+MPU_RBAR_OFFSET)=MPU_RASR_VALUE( MPU_XN_DISABLE , MPU_AP_FULL_ACCESS , MPU_TYPE_FLASH , 0 , MPU_REGION_SIZE_32B );
